...
export default function AccountSetupFlow({ onComplete, onCancel, welcome = false }) {
  ...
  if (step === "manual") {
    return <form onSubmit={saveManual} className="space-y-5">
      ...
      <div className="rounded-2xl border border-[#4F8CFF]/15 bg-[#4F8CFF]/[0.045] p-4 text-xs leading-relaxed text-[#8EA5CB]">L’ajout manuel crée le suivi du compte. Les trades seront ensuite ajoutés depuis le journal ou un import CSV.</div>
