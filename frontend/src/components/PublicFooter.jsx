    ...
    <div className="mx-auto grid max-w-[1280px] gap-10 lg:grid-cols-[1.4fr_repeat(3,1fr)]">
      <div>
        ...
        <form onSubmit={subscribe} className="mt-7 max-w-sm" aria-label={t("Inscription à la newsletter", "Newsletter subscription")}>
          ...
          <p className="mt-2 text-[10px] leading-4 text-[#5F6673]">{t("Confirmation par e-mail requise. Désinscription en un clic.", "Email confirmation required. Unsubscribe in one click.")} <Link to="/privacy" className="underline decoration-white/20 underline-offset-2 hover:text-white">{t("Confidentialité", "Privacy")}</Link></p>
