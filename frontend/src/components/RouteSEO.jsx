...
const pages = {
  ...
  "/legal-notice": ["Mentions légales — PipsEvo", "Informations légales sur l’édition et l’hébergement de PipsEvo."],
  "/cookies": ["Politique cookies — PipsEvo", "Informations sur les stockages nécessaires et les statistiques facultatives."],
  "/data-rights": ["Gestion de tes données — PipsEvo", "Exporter, rectifier ou supprimer les données de ton compte PipsEvo."],
...
const pagesEn = {
  ...
  "/legal-notice": ["Legal notice — PipsEvo", "Legal information about the publisher and hosting of PipsEvo."],
  "/cookies": ["Cookie policy — PipsEvo", "Information about required storage and optional analytics."],
  "/data-rights": ["Manage your data — PipsEvo", "Export, correct, or delete your PipsEvo account data."],
