...
export const PLANS = Object.freeze({
  beta: {
    ...
    features: [
      ...
      ...(FEATURE_FLAGS.mt5AutoSync ? ["Synchronisation automatique MetaTrader 4 / 5"] : []),
...
export const PRICING_COMPARISON = Object.freeze([
  {
    ...
    rows: [
      ...
      { label: "Synchronisation automatique MetaTrader 4 / 5", beta: FEATURE_FLAGS.mt5AutoSync ? true : "planned", essential: false, pro: FEATURE_FLAGS.mt5AutoSync ? true : "planned" },
    ],
  },
  {
    id: "discipline",
