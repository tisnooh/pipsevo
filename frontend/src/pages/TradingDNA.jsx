  ...
  return (
    <div className="pe-page pe-page-stack mx-auto max-w-[1800px]">
      ...
      <div className="pe-card pe-card-pad text-center">
        <div className="pe-metric-label">Trades analysés</div>
        <div className="font-numeric mt-2 text-5xl font-bold">{d.trades_logged}</div>
      </div>
      </>}
    </div>
  );
...
const Card = ({ icon: I, label, value, color }) => (
  <div className="pe-card pe-card-pad">
    <div className="pe-metric-label flex items-center gap-2"><I className="w-4 h-4" style={{color}}/> {label}</div>
