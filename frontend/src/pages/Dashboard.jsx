          ...
          <div className="h-[270px] px-3 pb-3 pt-4 sm:px-5">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={equityData} margin={{top:8,right:8,left:0,bottom:0}}>
                ...
                <Tooltip contentStyle={{ background: "#0B1020", border: "1px solid rgba(112,119,218,.3)", borderRadius: 8, color: "#F3F4F6", fontSize: 12, boxShadow: "0 12px 32px rgba(0,0,0,.38)" }} labelStyle={{ color: "#D6D9E2" }} itemStyle={{ color: accent }} wrapperStyle={{ outline: "none" }} />
    ...
    {data.length ? <div className="h-[270px] px-2 pb-3 pt-4 sm:px-5">
      <ResponsiveContainer width="100%" height="100%">
        <ScatterChart margin={{ top: 8, right: 14, bottom: 6, left: 0 }}>
          ...
          <Tooltip cursor={{ stroke: "rgba(128,103,244,.25)", strokeDasharray: "3 3" }} contentStyle={{ background: "#0B1020", border: "1px solid rgba(112,119,218,.3)", borderRadius: 8, color: "#F3F4F6", fontSize: 12, boxShadow: "0 12px 32px rgba(0,0,0,.38)" }} labelStyle={{ color: "#D6D9E2" }} itemStyle={{ color: accent }} wrapperStyle={{ outline: "none" }} formatter={(value, name) => [name === "pnl" ? money(value, { signDisplay: "always" }) : xFormatter(value), name === "pnl" ? "P&L" : title]} />
