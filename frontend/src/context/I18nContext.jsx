...
const EN = new Map([
  ...
  ["Bêta gratuite · Sans carte bancaire", "Free beta · No credit card"],
  ...
  ["Analyse tes performances, renforce ta discipline et protège tes comptes financés.", "Analyze your performance, strengthen your discipline, and protect your funded accounts."],
  ["Aucune carte bancaire requise pendant la bêta.", "No credit card required during the beta."],
  ...
  ["Mes données", "My data"], ["Export et portabilité", "Export and portability"], ["Portabilité de mes données", "My data portability"],
  ["Télécharge une copie complète des données liées à ton compte PipsEvo.", "Download a complete copy of the data associated with your PipsEvo account."],
  ["Exporter toutes mes données", "Export all my data"], ["Télécharger mon archive", "Download my archive"], ["Préparation…", "Preparing…"],
  ["L’archive ZIP contient des fichiers CSV séparés pour ton profil, tes préférences, tes comptes, tes trades, tes payouts et tes analyses Atlas. Seules tes données personnelles accessibles par ta session sont incluses.", "The ZIP archive contains separate CSV files for your profile, preferences, accounts, trades, payouts, and Atlas analyses. Only personal data accessible through your session is included."],
  ["Format UTF-8 compatible Excel. Les données de démonstration et les secrets d’authentification ne sont jamais inclus.", "Excel-compatible UTF-8 format. Demo data and authentication secrets are never included."],
